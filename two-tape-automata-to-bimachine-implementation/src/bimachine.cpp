...
//
//		//iterate through containing states in the new bimachine state xdd 
...
//			transitionsRight.insert(std::make_pair(std::make_pair(cntStates + 1, it_trans->first), statesR_RemapHashValues.at((*it_trans).second)));
//		}
//	}
